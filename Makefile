...
# bucket name - Use your Project's name as it should be unique
BUCKET_NAME=bitcoin-prediction-01
...
PACKAGE_NAME=BitcoinPrediction
FILENAME=trainer

##### Job - - - - - - - - - - - - - - - - - - - - - - - - -

JOB_NAME=bitcoin_prediction_training_pipeline_$(shell date +'%Y%m%d_%H%M%S')
